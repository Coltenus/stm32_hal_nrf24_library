...
int main(void)
{
  ...
  if(scan) {
    ...
    nrf24_rx_tx_init(tx_addr, tx_enabled);
  }
  /* USER CODE END 2 */
  ...
  while (1)
  {
    ...
    if(scan){
      ...
      if(nrf24_data_available()){
        ...
        printf("Data: %d\n", nrf24_uint8_t_to_type(dataR, sizeof(uint32_t)));
        uint8_t ack = 42;
        nrf24_transmit_rx_ack_pld(0, &ack, 1);
      }
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SPI2_CS_Pin|SPI2_CE_Pin, GPIO_PIN_RESET);
